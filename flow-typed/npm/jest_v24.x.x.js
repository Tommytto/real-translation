...
type JestObjectType = {
    ...
    /**
     * Exhausts the micro-_task queue (usually interfaced in node via
     * process.nextTick).
     */
    runAllTicks(): void,
    /**
     * Exhausts the macro-_task queue (i.e., all tasks queued by setTimeout(),
    ...
    /**
     * Executes only the macro _task queue (i.e. all tasks queued by setTimeout()
